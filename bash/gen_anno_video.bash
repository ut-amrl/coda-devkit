...
base_dir="/robodata/arthurz/Datasets/CODa_bbox_full/2d_rect_inorder/cam0"
out_dir="/robodata/arthurz/Media/CODa_bbox"

## Uncomment to generate egocomp point cloud segmentation
# base_dir="/robodata/arthurz/Datasets/CODa_sem_full/2d_raw_inorder/cam0"
...
for dir in "${base_dir}"/*; do
    if [[ -d "${dir}" ]]; then
        ...
        ffmpeg -start_number 0 -i ${dir}/%d.jpg -c:v libx264 -crf 30 "${output_video}"
